...
__R learning goals__ -- Tidyverse packages/paradigms (piping, tibbles, dplyr, lubridate, etc) -- Plotting with ggplot2 -- R markdown: html document
...
```{r data cleanup, include = FALSE, cache=TRUE}
...
allGIDRequests <- read_csv("get_it_done_311_requests_datasd.csv")
